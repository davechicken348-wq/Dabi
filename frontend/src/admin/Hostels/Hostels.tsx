          ...
          <div className={shared.sbSubGroup}>
            ...
            <div className={shared.sbSubGroupItems}>
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-up-right opacity-50"><path d="M7 7h10v10"></path><path d="M7 17 17 7"></path></svg>
              </NavLink>
              <NavLink
                to="/admin/hostels/new"
                className={({ isActive }) =>
